...
let defaults = {
  ...
  template: `<div class="yearpicker-container">
                    ...
                    <span class="yearpicker-prev" data-view="yearpicker-prev"><i class="fa-solid fa-angle-left fa-fw yearpicker-prev" data-view="yearpicker-prev"></i></span>
                        <div class="yearpicker-current" data-view="yearpicker-current">SelectedYear</div>
                        <span class="yearpicker-next" data-view="yearpicker-next"><i class="fa-solid fa-angle-right fa-fw yearpicker-next" data-view="yearpicker-next"></i></span>
                    </div>

...
<div class="intro-y datatable-wrapper box p-5 mt-5">
    <table class="table table-report table-report--bordered display nowrap datatable w-full">
        <thead>
            <tr>
                <th class="border-b-2 text-center whitespace-normal w-5">Judul</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="border-b text-center whitespace-nowrap">
                    <div class="whitespace-nowrap font-medium">{{$d->judul}}</div>
                </td>
                <td class="text-center border-b">{{$d->getjurusan()}} </td>
                <td class="text-center border-b whitespace-nowrap">{{$d->jenis_hibah->nama}} </td>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        ...
                        <a href="{{ route('penelitian.destroy', [$d->id]) }}" class="button px-2 mr-1 mb-2 bg-theme-31 text-theme-6 tooltip" title="Hapus"> <span class="w-5 h-5 flex items-center justify-center"> <i data-feather="trash-2" class="w-4 h-4"></i> </span> </a>
                    </div>
                </td>
                @endauth
            </tr>

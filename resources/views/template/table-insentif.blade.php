    ...
    <table class="table table-report table-report--bordered display datatable w-full">
        <thead>
            <tr>
                ...
                <th class="border-b-2 text-center whitespace-nowrap">Jenis Insentif</th>
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        {{-- <button class="show-data button px-2 mr-1 mb-2 bg-theme-14 text-theme-10 tooltip" data-url="{{ route('insentif.show', [$d->id]) }}" title="Lihat"> <span class="w-5 h-5 flex items-center justify-center"> <i data-feather="eye" class="w-4 h-4"></i> </span> </button> --}}
                        <a href="{{ route('insentif.edit', [$d->id]) }}" class="button btn-edit px-2 mr-1 mb-2 bg-theme-17 text-theme-11 tooltip" title="Edit"> <span class="w-5 h-5 flex items-center justify-center"> <i data-feather="edit-3" class="w-4 h-4"></i> </span> </a>

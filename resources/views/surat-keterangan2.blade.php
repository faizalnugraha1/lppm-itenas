...
<head>
    ...
    <title>Surat Keterangan - {{$dasur->nama_kegiatan}}</title>
...
<body>
    ...
    <div class="isi">
        <center>
            ...
            <p class="arial" style="font-size: 11pt; font-weight: bold;line-height: 0;">MELAKUKAKAN KEGIATAN {{Str::upper($dasur->nama_kegiatan)}}</p>
            <p class="arial" style="font-size: 11pt; font-weight: bold;line-height: 0;">INSTITUT TEKNOLOGI NASIONAL</p>
            <p class="arial" style="font-size: 11pt; font-weight: bold;line-height: 0;">No. {{$dasur->no_surat}}</p>
        </center>
    </div>
    ...
    <div class="isi arial">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width:5%;text-align: center">:</td>
                <td style="width:20%;font-size: 15px;">{{$dasur->getPembuat()->jabatan}}</td>
    ...
    {{-- <div class="arial"> --}}
        <table class="list-dosen" style="width: 90%;border-collapse:collapse;">
            ...
            @foreach ($dasur->getKegiatan()->getlistdosen() as $key => $d)
    ...
    <div class="isi arial">
        ...
        <table>
            <tr>
                ...
                <td style="width:20%;font-size: 15px;  vertical-align: top">{{$dasur->getKegiatan()->judul}}</td>

            </tr>
            @if(!empty($dasur->getKegiatan()->nama_mitra))
            <tr>
                <td style="width:10%;font-size: 15px;">
                    Tempat
                </td>
                <td style="width:5%;text-align: center">:</td>
                <td style="width:20%;font-size: 15px;">{{$dasur->getKegiatan()->nama_mitra}}</td>

            </tr>
            @endif
            @if($dasur->nama_kegiatan == 'Penelitian' || $dasur->nama_kegiatan == 'Pengabdian Kepada Masyarakat')
            <tr>
                ...
                <td style="vertical-align:top;width:2%;text-align: center">:</td>
                <td style="width:18%;font-size: 15px;">
                    {{Carbon::parse($dasur->getKegiatan()->mulai)->format('d F Y').' - '. Carbon::parse($dasur->getKegiatan()->selesai)->format('d F Y')}}
                </td>
            </tr>
            @elseif ($dasaur->nama_kegiatan == 'Hak Kekayaan Intelektual')
            <tr>
                <td style="vertical-align:top;width:10%;font-size: 15px;">
                    Waktu
                </td>
    ...
    <div class="ttd arial">
        <table style="float:right">
            <tr>
                <td>
                    Bandung, {{ \Carbon\Carbon::parse($dasur->created_at)->format('d F Y') }}
                </td>
            </tr>
            <tr>
                <td>
